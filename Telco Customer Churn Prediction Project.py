...
def load_default_dataset():
    ...
    try:
        ...
        dataset = pd.read_csv("C:/Users/USER1/PycharmProjects/AssignmentProject/WA_Fn-UseC_-Telco-Customer-Churn.csv")
        return dataset
...
def preprocess_data(df):
    ...
    st.session_state.scaler = scaler  # Stores the scaler object in streamlit's session state to reuse it across different pages or user interactions
